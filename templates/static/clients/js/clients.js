function add_carro(){
    ...
    html = "<br>  <div class='row'> <div class='col-md'> <input type='text' placeholder='Car' class='form-control' name='carro' > </div> <div class='col-md'><input type='text' placeholder='Patent' class='form-control' name='placa' ></div> <div class='col-md'> <input type='number' placeholder='Year' class='form-control' name='ano'> </div> </div>"
